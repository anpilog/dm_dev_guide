...
**Before creating a new change change-controlled document, reserve its handle on DocuShare.**
...
Watch for Slack messages from the bot about documents' GitHub repository, including a link to a pull request.
